...
import { EuroProtocolConfirmationFormComponent } from './euro-protocol-confirmation-form/euro-protocol-confirmation-form.component';
...
@NgModule({
  declarations: [
    ...
    EuroProtocolConfirmationFormComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
